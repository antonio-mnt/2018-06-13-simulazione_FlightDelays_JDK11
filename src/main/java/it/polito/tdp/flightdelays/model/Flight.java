...
public class Flight {
	...
	public String toString() {
		return "Flight [id=" + id + ", originAirportId=" + originAirportId + ", destinationAirportId="
				+ destinationAirportId + ", scheduledDepartureDate=" + scheduledDepartureDate + ", arrivalDate="
				+ arrivalDate + ", arrivalDelay=" + arrivalDelay + "]";
	}
